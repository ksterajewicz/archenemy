-- ~/archenemy/rices/crt/hypr/hyprland.lua
...
hl.config({
    general = {
        ...
        -- crt: ramka 1 px jak krawędź obrazu na lampie — aktywne okno w cyjanie
        -- fosforu (#36D2D8 → #5695D6, lekki gradient = nierówne świecenie),
        -- nieaktywne w głębokim błękicie (#0B358B).
        ["col.active_border"]   = { colors = { "rgb(36D2D8)", "rgb(5695D6)" }, angle = 45 },
        ["col.inactive_border"] = "rgba(0B358BCC)",
    ...
    decoration = {
        -- crt: lekko zaokrąglone rogi (4 px) — jak narożniki obrazu na kineskopie,
        -- ale bez „pigułek": ostro, technicznie.
        rounding = 4,

        active_opacity   = 1.0,
        inactive_opacity = 1.0,

        -- Blur włączony: półprzezroczyste płyty waybara/rofi/mako mają wyglądać
        -- jak szkło kineskopu nad tapetą. Noise podbite (0.02) = ziarno
        -- fosforu, brightness lekko w dół — szkło CRT jest ciemne.
        blur = {
            enabled           = true,
            size              = 6,
            passes            = 2,
        ...
        -- Cień = poświata fosforu wokół aktywnego okna (cyjan, ciasny rant jak
        -- w tronie). Nieaktywne: sam ciemny cień.
        shadow = {
            enabled        = true,
...
-- Layer rules — szkło kineskopu: blur pod waybarem, mako i rofi (tła płyt
-- mają alfa ≥ 0.5, żeby ignore_alpha je łapało).
